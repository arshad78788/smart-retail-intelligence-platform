...
st.info('CNN model runs locally. Below are the model results and performance metrics.')
...
st.markdown('- **Transfer Learning:** Base model frozen, only top layers trained')
